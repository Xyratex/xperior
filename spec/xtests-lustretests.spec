...
Summary: The Lustre acc small wrapper for XTests harnesss.
Name: xtests-lustretests
Version: 0.0.1 
Release: 4%{?dist} 
License: TBD 
Group: Development/Libraries
Source: XTests-lustretests-0.0.1.tar.gz
...
TBD
%prep
%setup -q -n XTests-lustretests-%{version}
