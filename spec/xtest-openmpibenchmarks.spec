...
Summary: The MDTest and IOR wrapper for XTest harnesss.
Name: xtest-openmpibenchmarks
Version: 0.0.2
Release: 4%{?dist} 
License: TBD 
Group: Development/Libraries
Source: XTest-openmpibenchmarks-0.0.2.tar.gz
Requires:  ior
...
TBD
%prep
%setup -q -n XTest-openmpibenchmarks-%{version}
