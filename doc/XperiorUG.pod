...
B<t>      - internal unit tests for Xperior::Core, allow quickly test how harness work. Could be useful for test how work after installation.
...
C<iorcmd>           - command for executing, specific parameter for Xperior::Executor::IOR. C<@mount_pointE@> and C<@test_fileE@> are variables from system configuration, see their definition in next section.
