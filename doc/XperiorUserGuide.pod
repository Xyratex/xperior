...
on the same host above.
 ...
 tempdir                 : /tmp
 testdir                 : relative/path/to/test/directory/where/tests/execute/
...
C<weight>            - defines order of execution. By defaul - 50. Lighter
tests is executed earlier. Suggest values: 0 - for sanity/smock, 50 - common functional,
100 - system-wide load tests
