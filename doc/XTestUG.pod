...
=head1 XTest harness user guide

=head2 Structure of /opt/xyratex/xtest folder
...
B<lib>    - XTest perl libraries, for overriding use PERL5LIB env variable. runtest.pl script try to find it as C<../lib> from his location
