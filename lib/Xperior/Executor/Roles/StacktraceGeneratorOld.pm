...
Xperior::Executor::Roles::StacktraceGeneratorOld - Role define generatig
...
StacktraceGeneratorOld with NetconsoleCollector or StoreConsole.


=cut

package Xperior::Executor::Roles::StacktraceGeneratorOld;
use strict;
use warnings;
use Moose::Role;
use Data::Dumper;
...
my $title = 'StacktraceGeneratorOld';
