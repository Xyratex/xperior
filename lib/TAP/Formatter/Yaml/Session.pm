package TAP::Formatter::Yaml::Session;
...
sub _closures {
    ...
    return {
        ...
        result => sub {
            ...
            # no idea what is it mean in yaml  case, disable now
              ...
              )
            {
                ...
                $formatter->_save_test_by_string($result);
                #$formatter->_output("\n");
            }
                #my $yr = 
                #    { apple => 'good', 
                ...
                #  };
                #print Dumper $parser;
                # $formatter->_write_test_result($yr);
        ...
        close_test => sub {
            ...
            #print "*********". Dumper $self->parser->result . "\n";
            ...
            if ( my $skip_all = $parser->skip_all ) {
                ...
                $formatter->_should_show_count;
                #print Dumper $parser;

            }
            #print Dumper $parser;
            $formatter->_write_test_result;
